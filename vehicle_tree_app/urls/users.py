...
from vehicle_tree_app.api.v1.users.users import (
    IndexView, LoginByNumberForGetCodeView, LoginByUsernameView, LogoutView, LoginByNumber, UserUpdateView,
    UserDeleteView,
    UserListView
)
...
user_url = [
    ...
    path('users/login/phoneforcode', LoginByNumberForGetCodeView.as_view(), name='LoginByNumber'),
    path('users/loginbyphone', LoginByNumber.as_view(), name='Loginv'),
